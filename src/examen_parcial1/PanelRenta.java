...
public class PanelRenta extends BaseGUI {
    ...
    private void actualizarInfo(){
        ...
        String info= "Codigo: "+ item.getCodigo()+"\nNombre: "+item.getNombre()
    ...
    private void calcularRenta(){
        ...
        if (diasStr == null || diasStr.trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Ingresar la cantidad de dias.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        JOptionPane.showMessageDialog(this,"Monto total de renta: "+total+"Lps."+"\nCopias Restantes: "+item.cantCopias,"Total Renta",JOptionPane.INFORMATION_MESSAGE);
    }
}
