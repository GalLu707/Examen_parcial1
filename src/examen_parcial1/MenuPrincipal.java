   ...
   public void initComponents(){
    ...
    private void agregarItem(){
       ...
       int tipo = JOptionPane.showOptionDialog(
        ...
        String codStr = JOptionPane.showInputDialog(this, "Código (número entero:D):");
        if (codStr == null) {
            return;
        }
        ...
        for (RentItem ri : rentItems) {
            if (ri.getCodigo() == codigo) {
                JOptionPane.showMessageDialog(this, "El código ya existe. :c ", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
